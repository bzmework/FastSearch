...
public:
    ...
    ) const
    {
        ...
        detail::static_asserts< detail::is_convertible<OtherT,IterT>::value > const iterator_types_are_not_convertible;
    ...
    ) const
    {
        ...
        detail::static_asserts< detail::is_convertible<iter_type,IterT>::value > const iterator_types_are_not_convertible;
        ( void ) iterator_types_are_not_convertible;
